...
defmodule Colins.Solvers.TrapezoidalRule do
  @moduledoc "
  ...
  def build_newton_raphson_edge_definitions(solver_id,edge_id,edge_definition) do
    ...
    pdfs = Colins.Erlport.Helper.differentiate(expr_string,var_string)
    ...
    Colins.Solvers.ImplicitSolverServer.notify_edge_complete(solver_id,edge_id,returned_values,nil,:build_newton_raphson_edge_definitions)
  ...
  def run_newton_raphson(solver_id,edge_id,edge_definition,node_data,step_calculated_data,step_size,timepoint,newton_raphson_edge_definition) do
    ...
    Colins.Solvers.ImplicitSolverServer.notify_edge_complete(solver_id,edge_id,returned_values,nil,:run_newton_raphson)
